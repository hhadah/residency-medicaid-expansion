...
%  {hyperref}
% hyperref is loaded second-to-last, and cleveref last, at the end of this file.
\usepackage{geometry}
\usepackage{appendix}
\usepackage{subcaption} % For subfigures
% Single-space the interior of floats: with \doublespacing active, the
% interline glue between stacked subfigures and around images otherwise
% inflates figure blocks past \textheight (blank pages / overfull output).
\usepackage{etoolbox}
...
%%%%%%%%%%% Hyperref (second-to-last) and Cleveref (last) %%%%%%%%%%%
...
% Capitalize cross-reference names so \cref renders "Figure 5" / "Section 4" (economics convention)
