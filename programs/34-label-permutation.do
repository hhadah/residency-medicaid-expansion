...
* script 20's mechanism analysis: never-expansion controls + the permuted-label
...
*
* This complements script 33's `mechdiff' spec, which holds labels fixed and permutes
* timing: script 33 tests the sharp null of no treatment effect; this script tests whether
...
* Runtime: 2 x REPS did_imputation calls (default 500). Smoke test: do 34-label-permutation.do 20
* =============================================================================
...
log using "${topdir}/output/34-label-permutation.log", replace
