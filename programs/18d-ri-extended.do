...
* ---------------------------------------------------------------------------
* The headline year-varying estimate gets RI in 18c; this script extends the
...
*
* Method (identical to 18/18c, incl. the 2026-07-24 permutation fix): reassign
...
* Runtime: ~6 specs x REPS did_imputation calls. Smoke test: do 18d-... 20
* =============================================================================
...
log using "${topdir}/output/18d-ri-extended.log", replace

local REPS = 500   // number of permutation draws
if "`1'" != "" local REPS = `1'   // optional override: do 18d-....do 20 (smoke test)
...
tempname ri
tempfile ri_file
postfile `ri' str24 spec double obs_att ri_p reps valid n_states n_treated_states ///
...
post `ri' ("urban") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})

global RI_SAMPLEIF "urban_rural == 1"
_rispec2 "rural" "`master_prog'" `REPS' "matched_per_100k_yr" 5 "autosample"
post `ri' ("rural") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})

global RI_SAMPLEIF "1"
_rispec2 "quota" "`master_prog'" `REPS' "quota_per_100k_yr" 5 ""
post `ri' ("quota") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})

global RI_SAMPLEIF "treated_state == 1"
_rispec2 "notyet" "`master_prog'" `REPS' "matched_per_100k_yr" 4 "autosample"
post `ri' ("notyet") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})

global RI_SAMPLEIF "specialty_group == 2"
_rispec2 "primary" "`master_spec'" `REPS' "matched_per_100k_yr" 5 ""
post `ri' ("primary") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})

global RI_SAMPLEIF "specialty_group == 1"
_rispec2 "nonprimary" "`master_spec'" `REPS' "matched_per_100k_yr" 5 ""
post `ri' ("nonprimary") (${RIG_obs}) (${RIG_rip}) (`REPS') (${RIG_valid}) (${RIG_Ns}) (${RIG_Ntr})
...
* class (mirroring script 24's mechanism construction; no autosample, as 24).
* Cohorts are permuted jointly over ALL states; formula classification is a
...
program define _mechdiff, rclass
    ...
    _avgatt2 `cohortvar' matched_per_100k_yr 5 ""
    local attA = r(att)
    restore
    preserve
