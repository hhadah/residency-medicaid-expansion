...
*   and a quota_per_100k_yr row (folds in the retired fixed-denominator quota script).
* =============================================================================
...
* Urban/rural (as in 14-dd-analysis-hetero): rural = RUCA > 3; missing RUCA excluded (2026-07-24
...
* GME formula classification (as in the archived formula-mechanism script)
preserve
