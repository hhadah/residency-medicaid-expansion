* =============================================================================
* Difference-in-Differences Analysis (UNWEIGHTED)
...
* Open log file
log using "${topdir}/output/07-dd-analysis-unweighted.log", replace
...
foreach outcome of global outcomes {
    ...
    di ""
    di "========================================================================="
    di "DID ANALYSIS (UNWEIGHTED): ${label_`outcome'}"
    ...
    * Calculate baseline mean (pre-treatment observations in treated states, unweighted)
    ...
    local plot_title "Event Study (Unweighted): `label'"
    ...
    * Adjust for per 100k outcomes
    ...
    graph export "${figdir}/`prefix'-did_`short'_event_unweighted.png", as(png) replace width(1200) height(800)
    graph export "${latex_figdir}/`prefix'-did_`short'_event_unweighted.png", as(png) replace width(1200) height(800)
    restore
    local ++plotnum
}
...
save "${tabdir}/did_summary_residency_unweighted.dta", replace
export delimited using "${tabdir}/did_summary_residency_unweighted.csv", replace

di ""
di "=================================================================="
di "Difference-in-differences estimates (UNWEIGHTED) completed for quota/matched/unmatched."
di "Summary table:"
di "  - ${tabdir}/did_summary_residency_unweighted.dta"
di "  - ${tabdir}/did_summary_residency_unweighted.csv"
di "Figures:"
di "  - ${figdir}/did_*_event_unweighted.png (and LaTeX copies)"
di "=================================================================="
