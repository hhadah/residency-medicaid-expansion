/*
Heterogeneity Analysis by Urban/Rural Classification - By Specialty Group (UNWEIGHTED)
...
* Open log file
log using "${topdir}/output/12-dd-analysis-hetero-byspecialty-unweighted.log", replace
...
*===============================================================================
* Heterogeneity Analysis - Urban vs Rural by Specialty (UNWEIGHTED)
*===============================================================================

di ""
di "========================================================================="
di "HETEROGENEITY ANALYSIS (UNWEIGHTED): By Urban/Rural within Specialty Groups"
di "Urban vs Rural"
di "========================================================================="
di ""
...
foreach spec of local spec_groups {
    ...
    di ""
    di "========================================================================="
    di "SPECIALTY GROUP (UNWEIGHTED): `spec_name' (Urban/Rural Heterogeneity)"
    di "========================================================================="
    di ""
    ...
    foreach outcome of global outcomes {
        ...
        di ""
        di "--- Outcome: `outcome' (Urban/Rural, UNWEIGHTED) ---"
        
        * Run did_imputation with heterogeneous effects by urban/rural within specialty (UNWEIGHTED)
        ...
        * Calculate baseline means (UNWEIGHTED; pre-treatment observations in estimation sample)
        quietly summarize `outcome' if specialty_group == `spec' & urban_rural == 0 & year < year_expanded & e(sample)
        local baseline_urban = r(mean)
        if missing(`baseline_urban') | `baseline_urban' == 0 {
            local baseline_urban = 1
        }
        
        quietly summarize `outcome' if specialty_group == `spec' & urban_rural == 1 & year < year_expanded & e(sample)
        ...
        * =====================
        ...
        local plot_title "Heterogeneity (Unweighted): `spec_name' - Urban vs Rural - `label'"
        ...
        graph export "${figdir}/`prefix'-hetero_urbanrural_`short'_`spec_clean'_event_unweighted.png", as(png) replace width(1200) height(800)
        graph export "${latex_figdir}/`prefix'-hetero_urbanrural_`short'_`spec_clean'_event_unweighted.png", as(png) replace width(1200) height(800)
...
di ""
di "========================================================================="
di "HETEROGENEITY ANALYSIS BY URBAN/RURAL WITHIN SPECIALTY (UNWEIGHTED) COMPLETED"
di "Event study plots saved to:"
di "  - ${figdir}/411-hetero_urbanrural_*_event_unweighted.png"
di "  - ${latex_figdir}/411-hetero_urbanrural_*_event_unweighted.png"
di "========================================================================="
