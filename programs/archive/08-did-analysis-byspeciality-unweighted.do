* =============================================================================
* Difference-in-Differences Analysis by Specialty Group (UNWEIGHTED)
...
* Open log file
log using "${topdir}/output/08-did-analysis-byspeciality-unweighted.log", replace
...
foreach spec of local spec_groups {
    * Get the specialty group name for this group
    ...
    di ""
    di "========================================================================="
    di "SPECIALTY GROUP (UNWEIGHTED): `spec_name'"
    di "========================================================================="
    ...
    foreach outcome of global outcomes {
        ...
        * Calculate baseline mean (pre-treatment observations for this specialty in treated states, unweighted)
        quietly summarize `outcome' if specialty_group == `spec' & treated_state == 1 & year < year_expanded
        ...
        * =====================================================================
        ...
        local plot_title "Event Study (Unweighted): `spec_name' - `label'"
        ...
        * Clean specialty name for filename
        ...
        graph export "${figdir}/`prefix'-did_`short'_`spec_clean'_event_unweighted.png", as(png) replace width(1200) height(800)
        graph export "${latex_figdir}/`prefix'-did_`short'_`spec_clean'_event_unweighted.png", as(png) replace width(1200) height(800)
        restore
        local ++plotnum
    }
}
...
save "${tabdir}/did_summary_residency_by_specialty_unweighted.dta", replace
export delimited using "${tabdir}/did_summary_residency_by_specialty_unweighted.csv", replace

di ""
di "=================================================================="
di "Difference-in-differences estimates (UNWEIGHTED) by specialty completed."
di "Summary table:"
di "  - ${tabdir}/did_summary_residency_by_specialty_unweighted.dta"
di "  - ${tabdir}/did_summary_residency_by_specialty_unweighted.csv"
di "Figures:"
di "  - ${figdir}/11-did_*_event_unweighted.png (and LaTeX copies)"
di "=================================================================="
